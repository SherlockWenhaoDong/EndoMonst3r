...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-path",
        type=Path,
        default=Path("/home/bygpu/Desktop/results/2_NON_RIGID_DEFORMATION_PULL/FAST_HORIZONTAL_PULL_CC/frames_cam0"),
        help="Path to the data directory (frames_cam0 or parent directory)"
    )
    parser.add_argument(
        "--calib-xml-path",
        type=Path,
        default='/home/bygpu/Desktop/results/2_NON_RIGID_DEFORMATION_PULL/Xi_Left.xml',
